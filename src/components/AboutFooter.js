            ...
            <div className="pg-footer">
                <footer className="footer about-footer">
                    <svg className="footer-wave-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 100" preserveAspectRatio="none">
                        <path className="footer-wave-path about-footer-wave-path" d="M851.8,100c125,0,288.3-45,348.2-64V0H0v44c3.7-1,7.3-1.9,11-2.9C80.7,22,151.7,10.8,223.5,6.3C276.7,2.9,330,4,383,9.8 c52.2,5.7,103.3,16.2,153.4,32.8C623.9,71.3,726.8,100,851.8,100z"></path>
                    </svg>
                    <div className="footer-content">
                        <div className="footer-content-column">
                            <div className="footer-logo about-footer-logo">
                                {/* <Link className="footer-logo-link" to="#">
                                    <span className="hidden-link-text">LOGO</span>
                                    <h1>LOGO</h1>
                                </Link> */}
                                <img src="./images/footer logo.png" alt="" />
                                <h1 className='footer-logo-text'>sample@gmail.com</h1>
                            </div>
                        ...
                        <div className="footer-content-column">
                            ...
                            <div className="footer-call-to-action">
                                ...
                                <p className="footer-call-to-action-link-wrapper"> <Link className="footer-call-to-action-link" to="tel:0124-64XXXX" target="_self"> 0124-64XXXX </Link></p>
                            </div>
                        </div>
